...
export default function Home() {
  ...
  const heroStatsGridClass =
    stats.length >= 4
      ? 'mx-auto mt-20 grid max-w-4xl grid-cols-2 gap-8 lg:grid-cols-4'
      : 'mx-auto mt-20 grid max-w-4xl grid-cols-3 gap-6';

  const aboutStatsGridClass =
    aboutStats.length >= 4
